...
model_uri = "https://myexperiments0584390316.blob.core.windows.net/azureml/ExperimentRun/dcid.gentle_prune_r3pqp41ypn/outputs/lstm_attn_vgg_full_2ep.pth"
vgg_model_uri = "https://myexperiments0584390316.blob.core.windows.net/azureml/ExperimentRun/dcid.sincere_heart_gzhryfgr86/outputs/vgg_full_1epochs.pth"
...
job = command(
    ...
    command=(
        "python -m scripts.test.test_lstm_attention_vgg_binary "
