...
model_uri = "https://myexperiments0584390316.blob.core.windows.net/azureml/ExperimentRun/dcid.purple_corn_hl8xz926v3/outputs/lstm_vgg_full_2ep.pth"
...
job = command(
    ...
    command=(
        "python -m scripts.test.test_lstm_vgg_binary "
