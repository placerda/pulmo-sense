...
# --- Sequence dataset for binary classification ---
class CCCCIIDatasetSequence2DBinary(Dataset):
    def __init__(self, dataset_folder, sequence_length=30, max_samples=None):
        ...
        dataset = CCCCIIDataset2DBinary(dataset_folder, transform=None, max_samples=max_samples)
        data = []
